    ...
    return (
        <DashboardLayout>
            ...
            <Grid container spacing={3}>
                {list.map((e, index) => (
                    <Grid item md={6} lg={4} key={index} onClick={() => handleClick(e._id)}>
                        <Card sx={{
                        padding:2,
                        backgroundColor: '#fff',
                        borderRadius: 4,
                                ...
                                <MDBox sx={{ display: 'flex', gap: 2, marginBottom: 2 }}>
                                    ...
                                    <MDBox sx={{ width: '60%', display: 'flex', flexDirection: 'column' }}>
                                        ...
                                        <MDBox sx={{ display: 'flex', alignItems: 'center', marginBottom: 1 }}>
                                            ...
                                            <MDTypography variant="body2" color="text" sx={{ marginLeft: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                                {e.clinicname}
                                            </MDTypography>
                                        </MDBox>
